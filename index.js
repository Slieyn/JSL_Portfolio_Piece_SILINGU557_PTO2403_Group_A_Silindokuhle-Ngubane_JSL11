...
const elements = {
  ...
  cancelEditBtn: document.getElementById("cancel-add-task-btn"),
...
function toggleModal(show, modal = elements.modalWindow) {
  console.log("thisIsMyModal", elements.modalWindow, modal);
...
function openEditTaskModal(task) {
  ...
  document.getElementById("save-task-changes-btn");
  ...
  console.log("modalHere", elements.openEditTaskModal);
